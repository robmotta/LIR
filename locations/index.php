...
<title>Locations || Love in Roatan</title>
        ...
        <div class="col-md-4 vendor-box"><!-- venue box start-->
          ...
          <div class="vendor-detail"><!-- venue details -->
            <div class="caption"><!-- caption -->
              ...
              <p class="location"><i class="fa fa-map-marker"></i> French Harbor, center of Roatan.</p>
              <div class="rating pull-left"><p>From an exclusive beach club to a white sand beach, different locations for you to choose in this hidden gem.</p></div>
            </div>
            <!-- /.caption -->
            <div class="vendor-price">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-5 ft-aboutus"><!-- about us-->
        ...
        <p>Sometimes getting married in a tropical island without knowing is hard to find what you need, we created this website to be able to grant you as much information as possibly collected, if there is anything we're missing please send us some feedback.
        <a href="#" class="btn tp-btn-default tp-btn-lg footer-contact" >Let's talk!</a> </div>
      <!-- about us-->
      <div class="col-md-3 ft-link"><!-- footer links -->
        <h2>Useful links</h2>
        <ul>
          <li><a href="#">Honeymoon spots</a></li>
          <li><a href="#">Utila</a></li>
          <li><a href="#">Roatan Artists</a></li>
          <li><a href="#">Food</a></li>
...
function initMap() {
  var map = new google.maps.Map(document.getElementById('googleMap'), {
    ...
    center: {lat: 16.3858743, lng: -86.4217671}
  });
...
var beaches = [
  ...
  ['Florist Vendor', 16.3858743, -86.4217671, 4, 'florist.png']
  ];
