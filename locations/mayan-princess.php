...
<title>Location | Mayan Princess</title>
      ...
      <div class="col-md-8 page-description">
        ...
        <div class="row">
          <div class="col-md-12 why-venue">
            ...
            <ul class="check-circle">
              <li>Welcome Party</li>
              <li>Save the Date 10% Discount</li>
        ...
        <div class="row">
          ...
          <div class="col-md-12" >
            <div class="well-box" id="inquiry">
              <h2>Wanna talk to our wedding pre-planner?</h2>
              <p>Drop us a line and we will contact you as soon as we can <br /><b>Avg. Response Time: <span style="color:red;">30min</span></b>.</p>
              <form class="">
                ...
                <div class="form-group">
                  ...
                  <div class="">
                    <select id="guest" name="guest" class="form-control">
                      <option value="35 to 50">1 to 50</option>
                      <option value="50  to 65">50  to 75</option>
                      <option value="65 to 85">75 to 100</option>
                      <option value="85 to 105">100 - 150</option>
                ...
                <div class="form-group">
                  <button name="submit" class="btn tp-btn-default tp-btn-lg btn-block">Contact Me!</button>
                </div>
              </form>
            </div>
          </div>
